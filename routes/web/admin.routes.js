...
const registerInventoryRoutes = require('./admin/modules/inventory.routes');
const registerOpeningHourRoutes = require('./admin/modules/opening-hours.routes');
const registerAdminLoanRoutes = require('./admin/modules/loans.routes');
const registerRbacRoutes = require('./admin/modules/rbac.routes');
